...
export const STRENGTHS_DATA: Strength[] = [
  {
    ...
    x: "left-[calc(50%-24px)] md:left-[50%]",
    y: "bottom-[30px] md:bottom-[110px]",
    color: "--ball-or",
  },
  {
    id: 2,
    ...
    y: "bottom-[280px] md:bottom-[280px]",
    color: "--ball-bl",
  },
  {
    id: 3,
    ...
    x: "left-[calc(50%-120px)] md:left-[calc(50%-200px)]",
    y: "bottom-[140px] md:bottom-[120px]",
    color: "--ball-yr",
  },
  {
    id: 4,
    ...
    x: "left-[calc(50%+60px)] md:left-[calc(50%+100px)]",
    y: "bottom-[170px] md:bottom-[260px]",
    color: "--ball-pk",
  },
  {
    id: 5,
    ...
    x: "left-[calc(50%+110px)] md:left-[calc(50%+180px)]",
    y: "bottom-[60px] md:bottom-[120px]",
    color: "--ball-or",
  },
];
